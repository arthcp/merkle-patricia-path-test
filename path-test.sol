    ...
    function exit(bytes calldata inputData) external {
        ...
        require(
            MerklePatriciaProof.verify(
                inputDataRLPList[1].toBytes(), // receipt
                inputDataRLPList[3].toBytes(), // branchMask
                inputDataRLPList[2].toBytes(), // receiptProof
                bytes32(inputDataRLPList[0].toUint()) // receiptRoot
            ),
